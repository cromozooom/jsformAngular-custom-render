...
export class AppComponent {
  renderers = [
    ...
    {
      tester: rankWith(5, departmentTester),
      renderer: CustomAutocompleteControlRenderer,
    },
    {
    ...
    {
      renderer: CustomRatingComponent,
      tester: customRatingTester,
    },
  ];
